        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="footer-contacts mb-30">
                    <h5 class="h5-md">{{ setting('salon.store') }}</h5>
                    <p class="p-lg">{{ setting('site.address') }}</p>

                    <h4 class="h4-sm txt-700 mt-4"><a href="tel:{{ setting('site.phone') }}"
                            class="rose--color">{{ setting('site.phone') }}</a></h4>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="footer-info mb-30">
                    <h5 class="h5-md">À propos</h5>
                    <p class="p-lg"><a href="{{ config('app.url') }}" target="_blank">Accueil</a></p>
                    <p class="p-lg"><a href="{{ route('privacy-policy') }}" target="_blank">Politique de
                            confidentialité</a></p>
                </div>
            </div>
