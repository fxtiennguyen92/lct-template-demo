@extends('op004.template.index')

@push('content')
    <!-- BANNER -->
    @php
        $banner = App\Models\PageSection::getFirstByCode('lanotte.home.banner', 'op004');
            ...
            <div class="row d-flex align-items-center">
                <div class="col-lg-10 offset-lg-1">
                    <div class="hero-3-txt text-center white--color">
                        ...
                        <a href="{{ setting('site.planity') }}" class="btn rose--btn tra-white--hover">Prendre
                            rendez-vous</a>
                    </div>
                </div>
            </div>
    ...
    <!-- ABOUT -->
    @php $about = App\Models\PageSection::getFirstByCode('lanotte.home.about', 'op004') @endphp
